...
class ErpLookupService {
    ...
    getItemName(lookupName, code) {
        var items = this.getItems(lookupName);
...
exports.ErpLookupService = ErpLookupService;
//# sourceMappingURL=erp-lookup.service.js.map